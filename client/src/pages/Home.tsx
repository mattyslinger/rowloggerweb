          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-black text-white rounded-2xl hover:bg-gray-900 transition-all hover:shadow-lg hover:-translate-y-0.5"
              >
